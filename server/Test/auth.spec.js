...
describe('User Authentications', function () {
  ...
  describe('User Registration', () => {
    ...
    it('should return 400 when user already exist', async () => {
      const res = await chai
      .request(app)
      .post('/api/auth/signup')
      .send(usermocks.validUserReg);
  ...
  describe('User Signin', () => {
    ...
    it('should return 422 for incorrect email', async () => {
      const res = await chai
      .request(app)
      .post('/api/auth/login')
    ...
    it('should return 422 for password not compactible', async () => {
      const res = await chai
      .request(app)
      .post('/api/auth/login')
      .send(usermocks.invalidPassword);
